...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("div#smsResult").hide(); // ajax에 한번 성공한 후 계속 나오면 안되기 때문에 처음에는 hide 시킨다.
			...
			$.ajax({
				...
				success:function(json){
					...
					if (json.success_count == 1) {
						...
						$("div#smsResult").html("문자 전송이 실패되었습니다.");
					}
...
<c:if test="${not empty mvo}">
	...
	<div id="mvoInfo">
		<ol>	
			...
			<li><span class="myli">성별 : </span><c:choose><c:when test="${mvo.gender == '1'}">남</c:when><c:otherwise>여</c:otherwise></c:choose></li>
