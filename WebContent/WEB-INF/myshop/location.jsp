...
<%-- 
 ...
 --%> 
 <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=91c04576743751526133c4595399ff47"></script> 
 <script type="text/javascript">
	$(document).ready(function() {
		...
		// 지도를 생성할 때 필요한 기본 옵션
		var options = {
		        center: new kakao.maps.LatLng(37.466296350084214, 126.86625605976509), // 지도의 중심좌표. 반드시 존재해야함.
	    ...
	    */
		...
		if (navigator.geolocation) {
			// HTML5 geolocation 으로 사용할 수 있는지 확인한다.
	    ...
	    kakao.maps.event.addListener(mapobj, 'click', function(mouseEvent) {
	 	...
	 	$.ajax({
	 		...
	 		async: false, 	// !!!! 지도는 비동기 통신이 아닌 동기 통신으로 해야 한다 !!!!
	 						// async: true ==> 비동기 통신이다. 생략하더라도 기본값이 true로 되어 있다.
	 						// async: false ==> 동기 통신이다. 
	 		dataType:"JSON",
