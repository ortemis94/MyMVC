		...
		<c:forEach var="pvo" items="${productList}" varStatus="status">
			<div class='moreProdInfo'>
	        	<ul style='list-style-type: none; border: solid 0px red; padding :0px; width :240px;'>
	                ...
	                <li><label class='prodInfo'>정가</label><span style="color: red; text-decoration: line-through;">${pvo.price}원</span></li>
	                <li><label class='prodInfo'>판매가</label><span style="color: red; font-weight: bold;">${pvo.saleprice}원</span></li>
