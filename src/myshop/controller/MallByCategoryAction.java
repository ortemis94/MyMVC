...
public class MallByCategoryAction extends AbstractController {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		// 한 페이지당 보여줄 제품의 개수는 10으로 한다. sizePerPage는 ProductDAO에서 상수로 설정해 두었음.
		...
		// 특정 카테고리에 속하는 제품들을 일반적이인 페이징 처리하여 조회(select) 해오기
	...
	//   System.out.println("~~~ 확인용 totalPage => " + totalPage);
	    ...
	    */
		...
		if ( pageNo != 1 ) {
			...
			pageBar += "&nbsp;<a href='mallByCategory.up?currentShowpage="+ (pageNo-1) +"&cnum="+ cnum +"'>[이전]</a>&nbsp;";
		}
